...
public class Student_04 implements Student{
    int mark,id;

    ExamController examController;

    public Student_04(ExamController s){
        examController = s;
        mark = -1;
        id = 4;
    }
    ...
    public void applyForReExamination() throws IOException{
        ...
        if(p==1){
            System.out.println("Re-examination request sent from student id 4");
            System.out.println("-----------------------------------------------------------------------------------------------");
